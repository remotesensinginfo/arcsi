...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="""Specify a scene date (YYYY-MM-DD).""",
    )
    parser.add_argument(
        "--sensor",
        type=str,
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="""List download command rather than just URL""",
    )
    parser.add_argument(
        "--outpath",
        type=str,
        help="""Output path for the landsat files to download to on your system. If not provided then will be defined as the current directory (i.e., '.')""",
    )
