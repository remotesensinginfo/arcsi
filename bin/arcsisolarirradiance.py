...
class ARCSISolarIrradiance(object):
    ...
    def calcSolarIrradiance(self, solarSpec, respFuncs, julianDay):
        ...
        solarSpecSub = numpy.where(
            ((solarWVs >= (minWv - 100)) & (solarWVs <= (maxWv + 100))),
            solarSpec,
            numpy.nan,
        )
...
if __name__ == "__main__":
    ...
    arcsiObj.run(
        args.input, args.sep, args.ignore, args.wvcol, args.rcol, args.julianday
    )
