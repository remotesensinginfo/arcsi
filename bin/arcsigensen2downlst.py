...
def genSen2DownloadList(dbFile, tile, outFile, outpath, cloudCover=None, startDate=None, endDate=None):
    """
    ...
    try:
        ...
        for row in ggSen2DBCursor.execute(query,  queryVar):
            cmdLst.append("gsutil -m cp -r " + row[0] + " " + outpath)
...
if __name__ == '__main__':
    ...
    genSen2DownloadList(args.dbfile, args.tile, args.output, args.outpath, args.cloudcover, args.startdate, args.enddate)
